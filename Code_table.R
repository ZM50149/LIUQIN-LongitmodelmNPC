##============================================================
## Data Loading, Variable Definition, Data Preprocessing,
## and Baseline Table Generation
##
## Purpose:
##   This script loads baseline and longitudinal follow-up data,
##   defines clinical variables, baseline laboratory biomarkers,
##   longitudinal trajectory classes, and FPCA-derived features.
##   It then converts variables into appropriate data types,
##   applies logarithmic transformation to skewed biomarkers,
##   defines a categorized KPS variable, and generates a baseline
##   characteristics table using the customized Table_f() function.
##============================================================
...
##============================================================
## 5. Generate baseline characteristics table stratified by OS
##============================================================
mydata <- df_baseline
