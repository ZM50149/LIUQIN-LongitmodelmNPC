##============================================================
## Prognostic Model Development, Validation, Risk Stratification,
...
##   5. Initialize objects for storing prognostic scores and C-index.
##   6. Build clinical model.
##   7. Build baseline biomarker model.
##   8. Build longitudinal trajectory class model.
##   9. Build FPCA-derived feature model using LASSO and AIC selection.
##   10. Build combined clinical plus EBV-DNA model.
##   11. Build combined clinical plus baseline biomarker model.
##   12. Build combined clinical, baseline biomarker, and trajectory model.
##   13. Build combined clinical, baseline biomarker, and FPCA model.
##   14. Build final integrated model.
##
## Notes:
